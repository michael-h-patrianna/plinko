```markdown
# Deprecated: Collision Detection Refactor Plan (2025-10-11)

This implementation plan has been removed. We don't keep historical step-by-step notes.

For current physics and collision information, see:
- docs/board-geometry.md
- docs/architecture.md

Authoritative implementation: src/plinko/game/**.
```

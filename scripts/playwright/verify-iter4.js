...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: 'screenshots/iter4-early.png' });
    console.log('  ✓ Early drop');

    await page.waitForTimeout(600);
    await page.screenshot({ path: 'screenshots/iter4-mid.png' });
    console.log('  ✓ Mid drop');

    await page.waitForTimeout(600);
    await page.screenshot({ path: 'screenshots/iter4-late.png' });
    console.log('  ✓ Late drop');

    await page.waitForTimeout(600);
    await page.screenshot({ path: 'screenshots/iter4-complete.png' });

...
async function test() {
  ...
  await page.screenshot({ path: 'screenshots/final-before.png' });
  ...
  await page.screenshot({ path: 'screenshots/final-early.png' });

  await page.waitForTimeout(500);
  console.log('Capturing mid drop (0.8s)...');
  await page.screenshot({ path: 'screenshots/final-mid.png' });

  await page.waitForTimeout(900);
  console.log('Capturing late drop (1.7s)...');
  await page.screenshot({ path: 'screenshots/final-late.png' });

  await page.waitForTimeout(1500);
  console.log('Capturing prize reveal (3.2s)...');
  await page.screenshot({ path: 'screenshots/final-reveal.png' });

  console.log('\n✅ Demo screenshots captured in ./screenshots');

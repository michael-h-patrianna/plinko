  ...
  try {
    ...
    for (const theme of themes) {
      ...
      await page.screenshot({
        path: `screenshots/ui-bug-${theme.toLowerCase().replace(' ', '-')}-start.png`,
        fullPage: true,
      });
      ...
      if (dropButton) {
        ...
        await page.screenshot({
          path: `screenshots/ui-bug-${theme.toLowerCase().replace(' ', '-')}-game.png`,
          fullPage: true,
        });
        ...
        await page.screenshot({
          path: `screenshots/ui-bug-${theme.toLowerCase().replace(' ', '-')}-result.png`,
          fullPage: true,
        });
    ...
    console.log('\nScreenshots saved under ./screenshots for analysis');
  } catch (error) {

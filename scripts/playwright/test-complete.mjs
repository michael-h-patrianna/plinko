...
try {
  ...
  if (startScreen) {
    ...
    await page.screenshot({ path: 'screenshots/default-theme.png', fullPage: true });
    console.log('   📸 Saved to screenshots/default-theme.png');
    ...
    if (board) {
      ...
      console.log('   📸 Saved to screenshots/board-visible.png');

      // Wait for ball to drop
      await page.waitForTimeout(5000);
      await page.screenshot({ path: 'screenshots/ball-dropped.png', fullPage: true });
      console.log('   📸 Saved to screenshots/ball-dropped.png');
    }
    ...
    if (themeSelector) {
      ...
      console.log('   📸 Saved to screenshots/playfame-theme.png');
      ...
      for (const theme of themes) {
        ...
        await page.waitForTimeout(1000);
        const fileName = `${theme.toLowerCase().replace(' ', '-')}-theme.png`;

...
async function test() {
  ...
  await page.screenshot({ path: 'screenshots/before-drop.png' });
  ...
  await page.screenshot({ path: 'screenshots/drop-0.5s.png' });

  await page.waitForTimeout(1000);
  console.log('Taking screenshot at 1.5s (mid drop)...');
  await page.screenshot({ path: 'screenshots/drop-1.5s.png' });

  await page.waitForTimeout(1500);
  console.log('Taking screenshot at 3s (late drop)...');
  await page.screenshot({ path: 'screenshots/drop-3s.png' });

  await page.waitForTimeout(2000);
  console.log('Taking screenshot at 5s (after animation)...');
  await page.screenshot({ path: 'screenshots/drop-5s.png' });

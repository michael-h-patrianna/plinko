...
import {
  ...
  PHYSICS,
  type DropZone,
} from '@plinko/game/boardGeometry';
import type { GameState, PrizeConfig, TrajectoryCache, TrajectoryPoint } from '@plinko/game/types';
...
import { getPrizeThemeColor } from '@plinko/theme/prizeColorMapper';
import { calculateBucketZoneY } from '@plinko/utils/slotDimensions';
import { hexToRgba } from '@plinko/utils/formatting/colorUtils';

...
import { usePrizeSession } from '@plinko/hooks/usePrizeSession';
import { useGameState } from '@plinko/hooks/useGameState';
import { useGameAnimation } from '@plinko/hooks/useGameAnimation';
import { useResetCoordinator } from '@plinko/hooks/useResetCoordinator';
import type { PrizeProvider, PrizeProviderResult } from '@plinko/game/prizeProvider';
      ...
      const { result: gameResult } = renderHook(
        () =>
          useGameState({
            ...
            currentWinningIndex: prizeResult.current.currentWinningIndex,

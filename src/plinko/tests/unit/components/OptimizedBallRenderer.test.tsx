...
import { OptimizedBallRenderer } from '@plinko/components/game/PlinkoBoard/components/OptimizedBallRenderer';
import type { TrajectoryCache } from '@plinko/game/types';

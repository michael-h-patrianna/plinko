...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: 'physics-fix-before.png' });

    const startButton = page.locator('button:has-text("Drop Ball")');
    await startButton.click();

    await page.waitForTimeout(800);
    await page.screenshot({ path: 'physics-fix-mid1.png' });
    console.log('Mid-drop 1 captured');

    await page.waitForTimeout(800);
    await page.screenshot({ path: 'physics-fix-mid2.png' });
    console.log('Mid-drop 2 captured');

    await page.waitForTimeout(1000);
    await page.screenshot({ path: 'physics-fix-end.png' });
